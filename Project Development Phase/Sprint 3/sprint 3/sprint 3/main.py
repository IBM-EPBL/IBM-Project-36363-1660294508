...
def RNewUser():
    if request.method == 'POST':
        ...
        insertQuery = "INSERT INTO regtb VALUES ('" + name1 + "','" + uname + "','" + email + "','" + pnumber + "','" + Age + "','" + password + "','" + gender1 + "')"
...
def userlogin():
    ...
    if request.method == 'POST':
        ...
        if dataframe.empty:
            ...
            return render_template('index5.html', data=engine.execute("SELECT * FROM Employee_Data").fetchall())
